<script>
  /**
   * WizardFrame · Frame para wizards multi-paso (Design System Beta 8.1).
   * ────────────────────────────────────────────────────────────────────
   * Usa tokens semánticos del Design System (--ink, --bg-window, --signal,
   * --warn, --crit, --line, etc.) definidos en src/app.css.
   *
   * Sustituyó al antiguo WizardModal (eliminado tras migrar los 3 wizards
   * de Storage: Create, Export, Destroy → ahora todos usan este frame).
   *
   * Props:
