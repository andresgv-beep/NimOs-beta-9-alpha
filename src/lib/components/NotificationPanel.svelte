...
<style>
  ...
  .sect-head .lbl { letter-spacing: 0; font-weight: 600; }
  .sect-head .ct { color: var(--signal); }
  ...
  .notif.success .notif-dot  { background: #3fb984; }
