...
<style>
  .ns-err { margin: -6px 0 12px; font-size: 11px; color: var(--st-crit, #ff5a5a); font-family: var(--font-sans); }

  .wl-form { display: flex; gap: 6px; margin-bottom: 14px; background: var(--bg-card, #15151a); padding: 10px; border: 1px solid var(--bd-2, #20202a); border-radius: 5px; }
  .wl-form input { background: var(--bg-inner, #101015); border: 1px solid var(--bd-2, #20202a); border-radius: 4px; padding: 7px 10px; color: var(--fg, #f0f0f0); font-family: var(--font-sans); font-size: 11px; outline: none; }
  .wl-form input:focus { border-color: rgba(91,143,249,0.5); }
  .wl-form input.ip { width: 190px; }
  .wl-form input.note { flex: 1; font-family: inherit; }
  .btn-add { padding: 0 16px; background: var(--signal, #5b8ff9); color: white; border: none; border-radius: 4px; font-family: var(--font-sans); font-size: 11px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 5px; }
  .btn-add:hover { filter: brightness(1.08); }
  .btn-add svg { width: 11px; height: 11px; pointer-events: none; }

  .wl-table { background: var(--bg-card, #15151a); border: 1px solid var(--bd-2, #20202a); border-radius: 5px; overflow: hidden; }
  .wl-head { display: grid; grid-template-columns: 140px 1fr 110px 60px; gap: 12px; padding: 9px 14px; background: var(--bg-inner, #101015); border-bottom: 1px solid var(--bd-2, #20202a); font-family: var(--font-sans); font-size: 10px; color: var(--fg-5, #5a5a62); font-weight: 600; }
  ...
  .wl-row.loopback { background: rgba(91,143,249,0.04); }
  .wl-loopback-tag { font-family: var(--font-sans); font-size: 9px; color: var(--signal, #5b8ff9); padding: 1px 5px; border: 1px solid rgba(91,143,249,0.35); border-radius: 3px; justify-self: start; }
