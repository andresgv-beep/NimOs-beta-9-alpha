...
[global]
# BEGIN NIMOS MANAGED SMB GLOBAL
   workgroup = WORKGROUP
   server string = NimOS NAS
# END NIMOS MANAGED SMB GLOBAL
...
# BEGIN NIMOS MANAGED SMB SHARES
# Shares are generated by the NimOS web interface after testparm validation.
# END NIMOS MANAGED SMB SHARES
EOF
